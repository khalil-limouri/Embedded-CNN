...
#define AI_NETWORK_MODEL_SIGNATURE     "31daad67b821c58e3ec86a515aebe48d"
...
#define AI_TOOLS_DATE_TIME   "Wed Oct  5 16:23:24 2022"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 80804);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80804);
    
    conv2d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 124004);
    conv2d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 124004);
    
    conv2d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 3072);
    conv2d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3072);
    
    conv2d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 115712);
    conv2d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 115712);
    ...
    conv2d_2_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 28160);
    conv2d_2_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 28160);
    
    conv2d_2_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 33792);
    conv2d_2_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 33792);
    ...
    conv2d_3_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 2560);
    conv2d_3_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2560);
    
    conv2d_4_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv2d_4_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    conv2d_4_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 512);
    conv2d_4_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 512);
    ...
    activation_6_output_array.data = AI_PTR(g_network_activations_map[0] + 8);
    activation_6_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv2d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 40448);
    conv2d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 40448);
    
    conv2d_2_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 40576);
    conv2d_2_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 40576);
    
    conv2d_2_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_2_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 114304);
    conv2d_2_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 114304);
    
    conv2d_3_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 114560);
    conv2d_3_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 114560);
    
    conv2d_3_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 262016);
    conv2d_3_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 262016);
    
    conv2d_4_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 262272);
    conv2d_4_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 262272);
    
    conv2d_4_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 336000);
    conv2d_4_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 336000);
    
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 336128);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 336128);
    
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 352512);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 352512);
    
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 352768);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 352768);
    
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 353280);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 353280);
