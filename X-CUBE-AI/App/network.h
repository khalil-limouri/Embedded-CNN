...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "model_small_b32"
...
#define AI_NETWORK_IN_1_WIDTH       (45)
#define AI_NETWORK_IN_1_CHANNEL     (3)
#define AI_NETWORK_IN_1_SIZE        (80 * 45 * 3)
#define AI_NETWORK_IN_1_SIZE_BYTES  (43200)
